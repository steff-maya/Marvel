...
public class CircleView extends View {
    ...
    private void updateCircleColor() {
        float colorProgress = (float) UtilsAnimation.clamp(outerCircleRadiusProgress, 0.5, 1);
        colorProgress = (float) UtilsAnimation.mapValueFromRangeToRange(colorProgress, 0.5f, 1f, 0f, 1f);
